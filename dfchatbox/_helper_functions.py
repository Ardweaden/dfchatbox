...
def translate(input,api_link="http://translate.dis-apps.ijs.si/translate?sentence=",yandex=False):
    ...
    if not yandex:
        ...
        url = "https://translate.yandex.net/api/v1.5/tr.json/translate?key=trnsl.1.1.20181126T094814Z.5af6ccc536a3d1d8.b4fb12893e5c327830c7a1f69e9242617d6042ea&lang=sl-en&text=" + input
        req = requests.get(url)
...
def search_in_data(data,phrase,hung=0,date=False,date_range=False):
    ...
    for i in range(len(data)):
        try:
            ...
            print(list(data[i].keys())[0][:-4] + "context/start_time")
